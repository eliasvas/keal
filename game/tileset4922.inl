...
#define TILESET_CIRCLE_TILE (v4(TILESET_RES_W*TILESET_STEP_X*40, TILESET_RES_H*TILESET_STEP_Y*(1), TILESET_RES_W*TILESET_STEP_X, -TILESET_RES_H*TILESET_STEP_Y))
